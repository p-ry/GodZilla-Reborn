...
public static double garbage =0;
       ...
       // final JoystickButton Climb = new JoystickButton(copilot, 8);
        ...
        public static Point2D.Double controlPoint2 = new Point2D.Double(-10.0,1200.0);//.2,0.6);
        public static Point2D.Double endPoint = new Point2D.Double(-20.1,1960.95);//0.0041,1.85795);
        /* Path follower */
