...
public abstract class DualArmSegmentBase extends SubsystemBase {// implements edu.wpi.first.util.sendable.Sendable {
  ...
  public DualArmSegmentBase(
    ...
    motorPosRequest = new PositionDutyCycle(0).withSlot(2);
    velocityRequest = new VelocityDutyCycle(0).withSlot(1);
  ...
  // leftConfig.MotorOutput.Inverted = invertLeft ?
  // InvertedValue.Clockwise_Positive
  // : InvertedValue.CounterClockwise_Positive;
  // rightConfig.MotorOutput.Inverted = invertRight ?
  // InvertedValue.Clockwise_Positive
  // : InvertedValue.CounterClockwise_Positive;

  // // PID (Slot0) initial values from your mutable fields
  // leftPID.kP = kP; leftPID.kI = kI; leftPID.kD = kD; leftPID.kS = kS;
  // leftPID.kV = 0.12; leftPID.kA = 0.01;
  // rightPID.kP = kP; rightPID.kI = kI; rightPID.kD = kD; rightPID.kS = kS;
  // rightPID.kV = 0.12; rightPID.kA = 0.01;

  // // Velocity (Slot1) initial values (same as your original)
  // leftPID1.kP = 0.02; leftPID1.kI = 0.0; leftPID1.kD = 0.0; leftPID1.kS = 0.3;
  // leftPID1.kV = 0.0; leftPID1.kA = 0.00;
  // rightPID1.kP = 0.02; rightPID1.kI = 0.0; rightPID1.kD = 0.0; rightPID1.kS =
  // 0.3; rightPID1.kV = 0.0; rightPID1.kA = 0.0;
  ...
  // InitLogger.logMessage(getClass().getSimpleName(),
  // String.format("refresh() failed (attempt %d/%d). Retrying in %.3fs. Left=%s
  // Right=%s",
  ...
  // failRefreshCount++;
  // InitLogger.logMessage(getClass().getSimpleName(),
  // String.format("PID/MM initialization skipped after %d failed refresh attempts
  // (failRefreshCount=%d)",
