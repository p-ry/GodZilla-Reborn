...
public class ArmAssembly extends SubsystemBase {
      ...
      public void setJointVelocities(double shoulderVelDegPerSec, double elbowVelDegPerSec, double sliderRPS) {
            ...
            // Slider: convert meters/sec to encoder units/sec (assumes 8.1 revs per 100cm
            // => 0.081 revs/cm => 0.81 revs/m)
      ...
      public boolean isAtLevel() {
            // SmartDashboard.putBoolean("Godzilla Be Ready", (lowerArm.atPos() &&
            // upperArm.atPos() && slider.atPos() ));
